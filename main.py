...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "train_random_forest" in active_steps:
            ...
            _ = mlflow.run(
                os.path.join(os.path.join(hydra.utils.get_original_cwd(), "src", "train_random_forest")),
                "main",
                parameters={
                    "trainval_artifact": 
        ...
        if "test_regression_model" in active_steps:
            ...
            _ = mlflow.run(
                os.path.join(os.path.join(hydra.utils.get_original_cwd()), "components", "test_regression_model"),
                "main",
                parameters={
