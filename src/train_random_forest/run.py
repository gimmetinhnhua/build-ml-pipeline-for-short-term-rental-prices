...
def go(args):
    ...
    try:
        ...
        logger.warning(f"Failed to load RF configuration from {args.rf_config}. Using default configuration.")
        rf_config = {"n_estimators": 100, "max_depth": 15, "min_samples_split": 4, "min_samples_leaf": 3, "n_jobs": -1, "criterion": "mae", "max_features": 0.5, "oob_score": True} # default configuration here
    ...
    artifact.metadata = {"rf_config": rf_config}
